 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon ){
    case 1: ballon.addImage(red_balloonImage); //chamar o balão vermelho
    break;
    case 2: ballon.addImage(blue_balloonImage); // chamar o balão azul
    break;
    case 3: ballon.addImage(green_balloonImage);// chamar o balão verde
    break;
    case 4: ballon.addImage(pink_balloonImage);// chamar o balão rosa
    break;
    default:break;
  }}
